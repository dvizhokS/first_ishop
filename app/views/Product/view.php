				...
				<div class="sngl-top">
					...
					<div class="col-md-7 single-top-right">
						...
						<h2>Lorem Ipsum</h2>
							...
							<h5 class="item_price" id="base-price" data-base="<?=$curr['symbol_left'];?><?=$product->price * $curr['value'];?><?=$curr['symbol_right'];?>"><?=$curr['symbol_left'];?><?=$product->price * $curr['value'];?><?=$curr['symbol_right'];?></h5>
							...
							<a id="productAdd" data-id="<?=$product->id;?>" href="card/add?id=<?=$product->id;?>" class="add-cart item_add add-to-cart-link">ADD TO CART</a>
