...
class Pagination{
    ...
    public function getHtml(){
        ...
        if($this->currentPage > 3){
            $startpage = "<li><a class='nav-link' href='{$this->uri}page=1" .
                        "'>&laquo;</a></li>";
        }
        if($this->currentPage < ($this->countPages - 2)){
            $endpage = "<li><a class='nav-link' href='{$this->uri}page=($this->countPages)".
                        "'>&raquo;</a></li>";
        }
        ...
        return '<ul class="pagination">' . $startpage . $back . $page2left . $page1left . 
                '<li class = "active"><a>' . $this->currentPage . '</a></li>' . $page1right . 
                $page2right . $forward. $endpage. '</ul>';
